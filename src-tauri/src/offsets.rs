...
pub mod d2client {
    ...
    /// Remove shadow patch point (RVA 0xA9A20 in D2Client.dll).
    /// Overwrites MISC_CalculateShadowRGBA entry with direct write of 0xFF to RGBA and ret 0x10.
    pub const REMOVE_SHADOW_PATCH: usize = 0xA9A20;
    pub const REMOVE_SHADOW_ORIGINAL: [u8; 31] = [
        0x51, 0x85, 0xC0, 0xC6, 0x04, 0x24, 0x00, 0xC6, 0x44, 0x24, 0x01, 0x00, 0xC6, 0x44, 0x24,
        0x02, 0x00, 0x0F, 0x84, 0x8E, 0x00, 0x00, 0x00, 0x56, 0xE8, 0xA1, 0x27, 0xF6, 0xFF, 0x83,
        0xF8,
    ];
    pub const REMOVE_SHADOW_PATCHED: [u8; 31] = [
        0x8B, 0x44, 0x24, 0x04, 0xC6, 0x00, 0xFF, 0x8B, 0x44, 0x24, 0x08, 0xC6, 0x00, 0xFF, 0x8B,
        0x44, 0x24, 0x0C, 0xC6, 0x00, 0xFF, 0x8B, 0x44, 0x24, 0x10, 0xC6, 0x00, 0xFF, 0xC2, 0x10,
        0x00,
    ];
...
pub mod d2sigma {
    ...
    /// In Median XL 2.14.3, the tooltip constructor function moved to 0xB5070 (resume 0xB5075).
    pub const TOOLTIP_ITEM_HOOK: usize = 0xB5070;
    pub const TOOLTIP_ITEM_HOOK_RESUME: usize = 0xB5075;
